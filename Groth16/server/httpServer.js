...
// Endpoint nhận commitment từ PI
...
// Không cần endpoint này theo sơ đồ - commitment được lưu local trên PI

app.listen(port, '0.0.0.0', () => {
  console.log('Server running on http://0.0.0.0:3000');
  console.log('Waiting for PI to connect...');
  console.log('Available endpoints:');
  console.log('   POST /commitment - Nhận commitment từ PI');
  console.log('   POST /proof - Nhận proof từ PI');
  console.log('   GET /nonce - Tạo nonce mới');
});
